...
import com.anarul.skwhatsapp.databinding.ActivitySettingBinding;
...
public class SettingActivity extends AppCompatActivity {
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Picasso.get().load(users.getProfilepic()).placeholder(R.drawable.ic_profile).
                                into(binding.profileImage);//for user profile picture upload

                        binding.etStatus.setText(users.getUserName());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data.getData()!=null){                     //for picture set
